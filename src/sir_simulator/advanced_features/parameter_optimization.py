...
from sir_simulator.core_models.seir_model import seir_equations
...
class ParameterOptimizer:
    ...
    def simulate(self, params, t, initial_conditions):
        ...
        if self.model_type == "sir":
            ...
            result = odeint(
                seir_equations, initial_conditions, t, args=(beta, sigma, gamma)
            )
            return result[:, 2]
...
def generate_synthetic_data(
    true_beta=0.5, true_gamma=0.2, S0=990, I0=10, R0=0, t_max=100, noise_level=5
):
